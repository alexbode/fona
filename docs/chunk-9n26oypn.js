import {z}from'./chunk-CN2SyqRp.js';import {f,x,b,g,v,y}from'./chunk-B_ILMItW.js';import {P,w,N as ma,j as je$1,F as CP,aa as UI,af as bP,I as Io,ag as eu,a as aE,C,m as it,U as n,ah as Oo,V as To,Y as Yo,B as Bf,c as bI,o as oc,a4 as LI,k as kE,d as PE,Q as Qf,t as ty,H as Hf,s as sp,a5 as jI,ad as ap,ai as Xf,e as RE,L as LE,R as RI,l as lc,ae as ep,y as kI,D as st,$ as ct,X as gt,aj as Fm,ak as Yf,al as nI,A as Ae,am as yn,a3 as $E,Z as ZE,an as lE,ao as sl,ap as ws,aq as Vf,ar as NP,as as rr,at as Br,au as je$2,av as we,aw as ke,ax as ce,ay as Gs,az as _,aA as hp,aB as yf,aC as xP,K as KE,J as JE,aD as rI,aE as Vf$1,aF as Zf,aG as eI,aH as tI,O as OE,aI as jm,a6 as Al,a7 as kl}from'./main-34TIMX2D.js';var Pe=(()=>{class o{static \u0275fac=function(t){return new(t||o)};static \u0275mod=lE({type:o});static \u0275inj=sl({imports:[ws]})}return o})();var Ne=(()=>{class o{_animationsDisabled=we();state="unchecked";disabled=false;appearance="full";static \u0275fac=function(t){return new(t||o)};static \u0275cmp=aE({type:o,selectors:[["mat-pseudo-checkbox"]],hostAttrs:[1,"mat-pseudo-checkbox"],hostVars:12,hostBindings:function(t,n){t&2&&ep("mat-pseudo-checkbox-indeterminate",n.state==="indeterminate")("mat-pseudo-checkbox-checked",n.state==="checked")("mat-pseudo-checkbox-disabled",n.disabled)("mat-pseudo-checkbox-minimal",n.appearance==="minimal")("mat-pseudo-checkbox-full",n.appearance==="full")("_mat-animation-noopable",n._animationsDisabled);},inputs:{state:"state",disabled:"disabled",appearance:"appearance"},decls:0,vars:0,template:function(t,n){},styles:[`.mat-pseudo-checkbox {
  border-radius: 2px;
  cursor: pointer;
...
`],encapsulation:2})}return o})(),Fe=(()=>{class o{static \u0275fac=function(t){return new(t||o)};static \u0275mod=lE({type:o});static \u0275inj=sl({imports:[Vf,Ue,ws]})}return o})();var Oe=(()=>{class o{static \u0275fac=function(t){return new(t||o)};static \u0275mod=lE({type:o});static \u0275inj=sl({imports:[ws]})}return o})();var T=class o{language=CP.required();accent=CP.required();sentenceIndex=CP.required();playbackSpeed=CP("100");dataService=w(ma);logger=w(Ae);isAudioPlaying=this.dataService.isAudioPlaying;audio=new Audio;constructor(){eu(()=>{this.sentenceIndex();this.audioResource(),this.stopAudio();}),eu(()=>{let a=this.playbackSpeed();this.audio&&(this.audio.playbackRate=parseInt(a,10)/100);});}ngOnDestroy(){this.audio.pause(),this.stopAudio();}config=UI(()=>{let a=this.language(),e=this.accent();return this.dataService.getCourseConfig(a,e)()});sentenceId=UI(()=>this.dataService.getChorusSessionState()().sentencesInSession[parseInt(this.sentenceIndex(),10)-1]);audioResource=UI(()=>{let a=this.sentenceId();return a?this.dataService.getAudio(a)():{value:null,isLoading:true,error:null}});handleAudioEnded=()=>{this.logger.debug("audio-player.ts handleAudioEnded"),this.dataService.setIsAudioPlaying(false),this.incrementCounter(),this.playAudio();};playAudio(){this.logger.debug("audio-player.ts playAudio");let a=this.audioResource();if(a.isLoading||!a.value){this.logger.debug("Audio is not ready to play yet.");return}this.isAudioPlaying()||(this.audio=new Audio(a.value),this.audio.currentTime=0,this.audio.onended=this.handleAudioEnded,this.audio.playbackRate=parseInt(this.playbackSpeed(),10)/100,this.audio.play().then(()=>{this.dataService.setIsAudioPlaying(true);}).catch(e=>{this.logger.error("Failed to play audio:",e),this.dataService.setIsAudioPlaying(false);}));}pauseAudio(){this.logger.debug("audio-player.ts pauseAudio"),this.audio.pause(),this.dataService.setIsAudioPlaying(false);}stopAudio(){this.logger.debug("audio-player.ts stopAudio"),this.audio.pause(),this.audio.currentTime=0,this.dataService.setIsAudioPlaying(false);}incrementCounter(){let a=this.sentenceId();a&&this.dataService.incrementSentenceCount(a,true);}onSpaceBar(){this.isAudioPlaying()?this.pauseAudio():this.playAudio();}static \u0275fac=function(e){return new(e||o)};static \u0275cmp=aE({type:o,selectors:[["app-audio-player"]],hostBindings:function(e,t){e&1&&Qf("keydown.space",function(){return t.onSpaceBar()},jm);},inputs:{language:[1,"language"],accent:[1,"accent"],sentenceIndex:[1,"sentenceIndex"],playbackSpeed:[1,"playbackSpeed"]},decls:0,vars:0,template:function(e,t){},dependencies:[Pe,Fe,yn,Oe],encapsulation:2})};var qe=()=>["25","50","75","90","100","110"];function Qe(o,a){o&1&&(Yo(0,"div",15),Bf(1,"div",33)(2,"div",34),oc());}function Ze(o,a){if(o&1&&(Yo(0,"div",40)(1,"p",41)(2,"span",42),bI(3,"pronunciation: "),oc(),bI(4),oc()()),o&2){let e=ZE(2);ty(4),lc(" ",e.sentencePinyin()," ");}}function Ye(o,a){if(o&1){let e=$E();Yo(0,"p",35),bI(1),oc(),Yo(2,"div",36)(3,"p",37),bI(4),oc(),Yo(5,"button",38),Qf("click",function(){Al(e);let n=ZE();return kl(n.onIpa())}),Bf(6,"ng-icon",39),bI(7," IPA "),oc()(),kE(8,Ze,5,1,"div",40);}if(o&2){let e=ZE();ty(),lc(" ",e.sentenceText()," "),ty(3),lc(" ",e.sentenceIpa()," "),ty(4),RE(e.hasPinyin()?8:-1);}}function Ke(o,a){if(o&1){let e=$E();Yo(0,"button",43),Qf("click",function(){let n=Al(e).$implicit,u=ZE();return kl(u.setSpeed(n))}),bI(1),oc();}if(o&2){let e=a.$implicit,t=ZE();ep("bg-background",t.playbackSpeed()===e)("text-foreground",t.playbackSpeed()===e)("text-muted-foreground",t.playbackSpeed()!==e)("shadow-sm",t.playbackSpeed()===e),ty(),lc(" ",e,"% ");}}function Je(o,a){o&1&&(Yo(0,"span",26),bI(1," ... "),oc());}function et(o,a){if(o&1&&(Yo(0,"span",27),bI(1),LI(2,"number"),oc()),o&2){let e=ZE();ty(),lc(" ",jI(2,1,e.allTimeReps())," ");}}function tt(o,a){if(o&1){let e=$E();Yo(0,"button",32),Qf("click",function(){Al(e);let n=ZE();return kl(n.previousSentence())}),bI(1," \u2190 Prev phrase "),oc();}}var Le=class o{AppRoutesHelper=P;dataService=w(ma);router=w(je$1);language=CP.required();accent=CP.required();sentenceIndex=CP.required();languagesState=this.dataService.getLanguageList();languageObj=UI(()=>{let a=this.languagesState().value;if(!a)return null;let e=this.language()?.toLowerCase();return a.find(t=>t.name.toLowerCase()===e)||null});accentObj=UI(()=>{let a=this.languageObj();if(!a)return null;let e=this.accent()?.toLowerCase();return a.accents.find(t=>t.name.toLowerCase()===e)||null});audioPlayer=bP(T);playbackSpeed=Io("100");setSpeed(a){this.playbackSpeed.set(a);}sessionCount=Io(0);cumulativeReps=Io(0);trackedSentenceId=-1;constructor(){let e=this.router.getCurrentNavigation()?.extras.state;this.cumulativeReps.set(e?.cumulativeReps??0),eu(()=>{let t=this.sentenceCount().value,n=this.sentenceCount().isLoading,u=this.sentenceId();n||t===null||t===void 0||!u||(this.trackedSentenceId!==u?(this.sessionCount.set(0),this.trackedSentenceId=u):this.sessionCount.update(Ve=>Ve+1));});}config=UI(()=>{let a=this.language(),e=this.accent();return this.dataService.getCourseConfig(a,e)()});sentenceId=UI(()=>this.dataService.getChorusSessionState()().sentencesInSession[parseInt(this.sentenceIndex(),10)-1]);numSentences=10;sentence=UI(()=>{let a=this.sentenceId();return a?this.dataService.getSentence(a)():{value:null,isLoading:true,error:null}});sentenceText=UI(()=>this.sentence().value?.text??"");sentenceIpa=UI(()=>this.sentence().value?.ipa??"");sentencePinyin=UI(()=>this.sentence().value?.pinyin??"");hasPinyin=UI(()=>!!this.sentencePinyin());allTimeRepsState=this.dataService.getTotalSentenceCount();allTimeReps=UI(()=>this.allTimeRepsState().value??0);previousSentence(){this.audioPlayer()?.stopAudio(),Number(this.sentenceIndex())>1&&this.router.navigate(P.getChorusDashboardRoute(this.language(),this.accent(),Number(this.sentenceIndex())-1),{state:{cumulativeReps:this.cumulativeReps()}});}nextSentence(){this.audioPlayer()?.stopAudio();let a=this.cumulativeReps()+this.sessionCount();Number(this.sentenceIndex())<this.numSentences&&this.router.navigate(P.getChorusDashboardRoute(this.language(),this.accent(),Number(this.sentenceIndex())+1),{state:{cumulativeReps:a}});}disablePreviousButton(){return Number(this.sentenceIndex())===1}disableNextButton(){return Number(this.sentenceIndex())===this.numSentences}sentenceCount=UI(()=>{let a=this.sentenceId();return a?this.dataService.getSentenceCount(a)():{value:null,isLoading:false,error:null}});handlePlay(){this.dataService.isAudioPlaying()?this.audioPlayer()?.stopAudio():this.audioPlayer()?.playAudio();}handleNext(){this.audioPlayer()?.stopAudio();let a=this.cumulativeReps()+this.sessionCount();Number(this.sentenceIndex())<this.numSentences?this.router.navigate(P.getChorusDashboardRoute(this.language(),this.accent(),Number(this.sentenceIndex())+1),{state:{cumulativeReps:a}}):this.router.navigate(P.getSummaryRoute(this.language(),this.accent()),{state:{mode:"chorusing",reps:a,total:this.numSentences,accent:this.accentObj()?.nativeName||this.accent()}});}onIpa(){this.audioPlayer()?.stopAudio(),this.router.navigate(P.getIpaRoute());}onBack(){this.audioPlayer()?.stopAudio(),this.router.navigate(P.getModeSelectionRoute(this.language(),this.accent()));}Number=Number;static \u0275fac=function(e){return new(e||o)};static \u0275cmp=aE({type:o,selectors:[["app-chorus-dashboard"]],viewQuery:function(e,t){e&1&&Yf(t.audioPlayer,T,5),e&2&&nI();},hostBindings:function(e,t){e&1&&Qf("keydown.arrowleft",function(){return t.previousSentence()},Fm)("keydown.arrowright",function(){return t.nextSentence()},Fm);},inputs:{language:[1,"language"],accent:[1,"accent"],sentenceIndex:[1,"sentenceIndex"]},features:[kI([st({lucideChevronLeft:gt,lucideBookOpen:ct})])],decls:58,vars:26,consts:[[1,"flex","flex-col","flex-1","h-full","bg-background","select-none"],[1,"hidden",3,"language","accent","sentenceIndex","playbackSpeed"],["hlmBreadcrumb","",1,"px-5","py-4","shrink-0"],["hlmBreadcrumbList",""],["hlmBreadcrumbItem",""],["hlmBreadcrumbLink","",3,"link"],["hlmBreadcrumbSeparator",""],["hlmBreadcrumbPage",""],[1,"px-5","pb-4","shrink-0"],[1,"flex","items-center","justify-between","mb-2"],[1,"text-muted-foreground","text-xs"],[1,"h-[2px]","bg-secondary","rounded-full","overflow-hidden"],[1,"h-full","bg-primary","rounded-full","transition-all","duration-500"],[1,"flex-1","flex","flex-col","px-5","pb-8","gap-5","overflow-y-auto"],[1,"bg-card","border","border-border","rounded","p-5","space-y-3"],[1,"animate-pulse","space-y-3"],[1,"bg-card","border","border-border","rounded","p-5","flex","flex-col","gap-3","justify-center","h-28"],[1,"flex","items-center","justify-between"],[1,"text-xs","font-medium","text-muted-foreground"],[1,"flex","items-center","justify-center","p-1","bg-secondary","rounded-lg","border","border-border"],["type","button",1,"flex-1","py-1.5","text-xs","font-semibold","rounded","transition-all","cursor-pointer","text-center","font-jakarta",3,"bg-background","text-foreground","text-muted-foreground","shadow-sm"],[1,"bg-card","border","border-border","rounded","py-5","px-5","flex","items-center","justify-between"],[1,"flex","flex-col","items-center","flex-1"],[1,"flex","items-center","justify-center","min-w-[40px]","h-10","px-3","rounded-full","border","border-brand/20","text-brand","bg-brand/10","font-bold","text-lg"],[1,"text-muted-foreground","text-xs","mt-1"],[1,"w-px","h-16","bg-border","mx-4","shrink-0"],[1,"text-4xl","font-bold","leading-none","animate-pulse","text-muted-foreground","font-jakarta"],[1,"text-4xl","font-bold","leading-none","text-muted-foreground","font-jakarta"],[1,"text-muted-foreground","text-xs","tracking-widest","uppercase","mt-1"],["appButton","","size","none",1,"w-full","py-4","rounded","text-base","cursor-pointer","gap-2","text-white","font-jakarta",3,"click"],[1,"flex","gap-3"],["appButton","","variant","secondary","size","none",1,"flex-1","py-4","rounded","text-sm","cursor-pointer"],["appButton","","variant","secondary","size","none",1,"flex-1","py-4","rounded","text-sm","cursor-pointer",3,"click"],[1,"h-6","bg-muted","rounded","w-3/4"],[1,"h-4","bg-muted","rounded","w-1/2"],[1,"text-foreground","text-2xl","lg:text-3xl","font-semibold","leading-normal","font-jakarta"],[1,"flex","items-center","justify-between","gap-3"],[1,"text-muted-foreground","text-base","lg:text-lg","flex-1","font-mono"],[1,"flex","items-center","gap-1","px-2.5","py-1","rounded","border","border-brand/20","text-brand","bg-brand/5","text-xs","shrink-0","hover:border-brand/40","cursor-pointer",3,"click"],["hlm","","name","lucideBookOpen","size","11px"],[1,"border-t","border-border","pt-3"],[1,"text-xs","text-muted-foreground"],[1,"text-primary"],["type","button",1,"flex-1","py-1.5","text-xs","font-semibold","rounded","transition-all","cursor-pointer","text-center","font-jakarta",3,"click"]],template:function(e,t){e&1&&(Yo(0,"div",0),Bf(1,"app-audio-player",1),Yo(2,"nav",2)(3,"ol",3)(4,"li",4)(5,"a",5),bI(6,"Languages"),oc()(),Bf(7,"li",6),Yo(8,"li",4)(9,"a",5),bI(10),LI(11,"titlecase"),oc()(),Bf(12,"li",6),Yo(13,"li",4)(14,"a",5),bI(15),LI(16,"titlecase"),oc()(),Bf(17,"li",6),Yo(18,"li",4)(19,"span",7),bI(20,"Chorusing"),oc()()()(),Yo(21,"div",8)(22,"div",9)(23,"span",10),bI(24),oc(),Yo(25,"span",10),bI(26," phrase "),oc()(),Yo(27,"div",11),Bf(28,"div",12),oc()(),Yo(29,"div",13)(30,"div",14),kE(31,Qe,3,0,"div",15)(32,Ye,9,3),oc(),Yo(33,"div",16)(34,"div",17)(35,"span",18),bI(36," Playback Speed "),oc()(),Yo(37,"div",19),PE(38,Ke,2,9,"button",20,OE),oc()(),Yo(40,"div",21)(41,"div",22)(42,"div",23),bI(43),oc(),Yo(44,"div",24),bI(45," repititions "),oc()(),Bf(46,"div",25),Yo(47,"div",22),kE(48,Je,2,0,"span",26)(49,et,3,3,"span",27),Yo(50,"div",28),bI(51," all time "),oc()()(),Yo(52,"button",29),Qf("click",function(){return t.handlePlay()}),bI(53),oc(),Yo(54,"div",30),kE(55,tt,2,0,"button",31),Yo(56,"button",32),Qf("click",function(){return t.handleNext()}),bI(57),oc()()()()),e&2&&(ty(),Hf("language",t.language())("accent",t.accent())("sentenceIndex",t.sentenceIndex())("playbackSpeed",t.playbackSpeed()),ty(4),Hf("link",t.AppRoutesHelper.getLanguagesRoute()),ty(4),Hf("link",t.AppRoutesHelper.getAccentsRoute(t.language().toLowerCase())),ty(),sp(jI(11,21,t.languageObj()?.nativeName)),ty(4),Hf("link",t.AppRoutesHelper.getModeSelectionRoute(t.language().toLowerCase(),t.accent().toLowerCase())),ty(),sp(jI(16,23,t.accentObj()?.nativeName)),ty(9),ap(" ",t.sentenceIndex()," / ",t.numSentences," "),ty(4),Xf("width",t.Number(t.sentenceIndex())/t.numSentences*100,"%"),ty(3),RE(t.sentence().isLoading?31:32),ty(7),LE(RI(25,qe)),ty(5),lc(" ",t.sessionCount()," "),ty(5),RE(t.allTimeRepsState().isLoading?48:49),ty(4),ep("bg-brand-hover",t.dataService.isAudioPlaying()),ty(),lc(" ",t.dataService.isAudioPlaying()?"\u{1F50A} Listening \u2014 speak along!":"\u25B6 Play & Chorus"," "),ty(2),RE(t.Number(t.sentenceIndex())>1?55:-1),ty(2),lc(" ",t.Number(t.sentenceIndex())<t.numSentences?"Next phrase \u2192":"Finish session \u2192"," "));},dependencies:[T,C,it,n,z,f,x,b,g,v,y,Oo,To],styles:["@keyframes _ngcontent-%COMP%_bounce-wave{0%,to{transform:scaleY(.25);background-color:#4badc866}50%{transform:scaleY(1);background-color:#4badc8d9}}.waveform-bar[_ngcontent-%COMP%]{transform-origin:center;will-change:transform,background-color}.waveform-bar.animating[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_bounce-wave .8s ease-in-out infinite}"]})};export{Le as ChorusDashboard};