...
function ie(t, a) {
  t & 1 && (jo(0, 'mat-error'), RE(1, 'Email is required'), Va());
}
function te(t, a) {
  t & 1 && (jo(0, 'mat-error'), RE(1, 'Please enter a valid email address'), Va());
}
function ne(t, a) {
  t & 1 && (jo(0, 'mat-error'), RE(1, 'Password is required'), Va());
}
function re(t, a) {
  if ((t & 1 && (jo(0, 'div', 8), RE(1), Va()), t & 2)) {
    let l = nE();
    (km(), $a(' ', l.errorMessage(), ' '));
  }
}
  ...
  static ɵcmp = Av({
    ...
    template: function (l, e) {
      (l & 1 &&
        ...
        jo(7, 'p'),
        RE(8, 'Sign in with Email'),
        Va(),
        jo(9, 'mat-form-field', 3)(10, 'mat-label'),
        RE(11, 'Email / Username'),
        Va(),
        Ef(12, 'input', 4),
        $y(),
        Kv(13, ie, 2, 0, 'mat-error'),
        Kv(14, te, 2, 0, 'mat-error'),
        Va(),
        ...
        l & 2 &&
          ...
          km(4),
          vf('href', jE(e.appRoutesHelper.urlPaths.Signup), od)));
    },
    dependencies: [
      Mn,
      Vn,
