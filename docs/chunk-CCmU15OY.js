...
`],encapsulation:2})}return i})(),F=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=Rv({type:i});static \u0275inj=Uc({imports:[jl,O,on]})}return i})();var L=class i{language=yO.required();accent=yO.required();sentenceId=yO.required();dataService=E(k);logger=E(dl);isPlaying=_e(false);audio=new Audio;playbackSpeed="100";constructor(){bs(()=>{this.sentenceId();this.stopAudio();});}audioResource=YE({params:()=>({lang:this.language(),acc:this.accent(),id:this.sentenceId()}),loader:async({params:a})=>{if(!a.lang||!a.acc||!a.id)return;let e=await this.dataService.getPresignedUrl(a.lang,a.acc,a.id);return new Audio(e)}});handleAudioEnded=()=>{this.logger.debug("audio-player.ts handleAudioEnded"),this.isPlaying.set(false),this.playAudio();};playAudio(){this.logger.debug("audio-player.ts playAudio"),this.isPlaying()||(this.audio=this.audioResource.value()||new Audio(""),this.audio.onended=this.handleAudioEnded,this.audio.load(),this.audio.playbackRate=parseInt(this.playbackSpeed,10)/100,this.audio.play(),this.isPlaying.set(true));}pauseAudio(){this.logger.debug("audio-player.ts pauseAudio"),this.audio.pause(),this.isPlaying.set(false);}stopAudio(){this.logger.debug("audio-player.ts stopAudio"),this.audio.pause(),this.audio.currentTime=0,this.isPlaying.set(false);}onSpaceBar(){this.isPlaying()?this.pauseAudio():this.playAudio();}static \u0275fac=function(e){return new(e||i)};static \u0275cmp=Av({type:i,selectors:[["app-audio-player"]],hostBindings:function(e,n){e&1&&Cf("keydown.space",function(){return n.onSpaceBar()},gm);},inputs:{language:[1,"language"],accent:[1,"accent"],sentenceId:[1,"sentenceId"]},decls:19,vars:2,consts:[["mat-raised-button","",3,"click"],["name","playBackSpeed","aria-label","Play Back Speed",3,"ngModelChange","ngModel"],["value","25"],["value","50"],["value","75"],["value","90"],["value","100"],["value","110"]],template:function(e,n){e&1&&(jo(0,"button",0),Cf("click",function(){return n.playAudio()}),RE(1,"Play Audio"),Va(),jo(2,"button",0),Cf("click",function(){return n.stopAudio()}),RE(3,"Stop Audio"),Va(),jo(4,"p"),RE(5),Va(),jo(6,"mat-button-toggle-group",1),Vf("ngModelChange",function(o){return FE(n.playbackSpeed,o)||(n.playbackSpeed=o),o}),jo(7,"mat-button-toggle",2),RE(8,"25%"),Va(),jo(9,"mat-button-toggle",3),RE(10,"50%"),Va(),jo(11,"mat-button-toggle",4),RE(12,"75%"),Va(),jo(13,"mat-button-toggle",5),RE(14,"90%"),Va(),jo(15,"mat-button-toggle",6),RE(16,"100%"),Va(),jo(17,"mat-button-toggle",7),RE(18,"110%"),Va()(),$y()),e&2&&(km(5),Ff(n.isPlaying()),km(),jf("ngModel",n.playbackSpeed),Wy());},dependencies:[tE,eE,lw,F,$,O,An,yn,Zt],encapsulation:2})};function Ke(i,a){if(i&1&&(Ha(0,"p"),RE(1),Ba()),i&2){let e=nE();km(),$a("pinyin: ",e.pinyin());}}var V=class i{dataService=E(k);logger=E(dl);language=yO.required();accent=yO.required();sentenceId=yO.required();sentencesResource=YE({params:()=>({lang:this.language(),acc:this.accent(),id:this.sentenceId()}),loader:async({params:a})=>{if(!(!a.lang||!a.acc||!a.id))return await this.dataService.getSentences(a.lang,a.acc,a.id)}});sentence=it(()=>this.sentencesResource.hasValue()?this.sentencesResource.value().find(e=>String(e.sentenceId)===this.sentenceId()):{});text=it(()=>this.sentence()?.text);ipa=it(()=>this.sentence()?.ipa);pinyin=it(()=>this.sentence()?.pinyin);hasPinyin=it(()=>this.pinyin.length>1);static \u0275fac=function(e){return new(e||i)};static \u0275cmp=Av({type:i,selectors:[["app-sentence-text"]],inputs:{language:[1,"language"],accent:[1,"accent"],sentenceId:[1,"sentenceId"]},decls:7,vars:3,template:function(e,n){e&1&&(Ha(0,"p"),RE(1,"sentence-text works!"),Ba(),Ha(2,"p"),RE(3),Ba(),Ha(4,"p"),RE(5),Ba(),Kv(6,Ke,2,1,"p")),e&2&&(km(3),$a("text: ",n.text()),km(2),$a("ipa: ",n.ipa()),km(),Jv(n.hasPinyin()?6:-1));},encapsulation:2})};var Re=class i{router=E(rn);language=yO.required();accent=yO.required();sentenceId=yO.required();maxSentenceId=20;previousSentence(){Number(this.sentenceId())>1&&(this.router.navigate([this.language(),this.accent(),Number(this.sentenceId())-1]),this.router.navigate([this.language(),this.accent(),Number(this.sentenceId())-1]));}nextSentence(){Number(this.sentenceId())<this.maxSentenceId&&this.router.navigate([this.language(),this.accent(),Number(this.sentenceId())+1]);}disablePreviousButton(){return Number(this.sentenceId())===1}disableNextButton(){return Number(this.sentenceId())===this.maxSentenceId}static \u0275fac=function(e){return new(e||i)};static \u0275cmp=Av({type:i,selectors:[["app-chorus-dashboard"]],hostBindings:function(e,n){e&1&&Cf("keydown.arrowleft",function(){return n.previousSentence()},hm)("keydown.arrowright",function(){return n.nextSentence()},hm);},inputs:{language:[1,"language"],accent:[1,"accent"],sentenceId:[1,"sentenceId"]},decls:8,vars:8,consts:[[3,"language","accent","sentenceId"],["mat-raised-button","",3,"click","disabled"]],template:function(e,n){e&1&&(jo(0,"p"),RE(1,"chorus-dashboard works!"),Va(),Ef(2,"app-sentence-text",0),jo(3,"button",1),Cf("click",function(){return n.previousSentence()}),RE(4,` Previous Sentence
`),Va(),jo(5,"button",1),Cf("click",function(){return n.nextSentence()}),RE(6,` Next Sentence
`),Va(),Ef(7,"app-audio-player",0)),e&2&&(km(2),vf("language",n.language())("accent",n.accent())("sentenceId",n.sentenceId()),km(),vf("disabled",n.disablePreviousButton()),km(2),vf("disabled",n.disableNextButton()),km(2),vf("language",n.language())("accent",n.accent())("sentenceId",n.sentenceId()));},dependencies:[tE,eE,lw,F,L,V],encapsulation:2})};export{Re as ChorusDashboard};