import {O as SP,w,m as ma,A as Ae,as as tu,aa as KI,g as gE,aG as yn,Q as iI,ai as ac,R as RI,ak as cc,V as sI,aj as qf,u as uy,ap as fp,aH as rp,aI as yE,aJ as sl,aK as ws,aL as Vf,aM as OP,aN as or,aO as Br,aP as je,aQ as we,aR as ke,aS as ce$1,aT as Gs,aU as _,aV as wp,T as To,aW as yf,aX as LP,e as ei,K as Kf,H as HE,s as sc,U as Uf,aY as dI,$ as $f,ah as Bf,B as BE,aq as op,aZ as Xf,a_ as cI,a$ as lI,r as rI}from'./main-P6WHSRCO.js';var ne=(()=>{class n{static \u0275fac=function(a){return new(a||n)};static \u0275mod=yE({type:n});static \u0275inj=sl({imports:[ws]})}return n})();var ae=(()=>{class n{_animationsDisabled=we();state="unchecked";disabled=false;appearance="full";static \u0275fac=function(a){return new(a||n)};static \u0275cmp=gE({type:n,selectors:[["mat-pseudo-checkbox"]],hostAttrs:[1,"mat-pseudo-checkbox"],hostVars:12,hostBindings:function(a,t){a&2&&op("mat-pseudo-checkbox-indeterminate",t.state==="indeterminate")("mat-pseudo-checkbox-checked",t.state==="checked")("mat-pseudo-checkbox-disabled",t.disabled)("mat-pseudo-checkbox-minimal",t.appearance==="minimal")("mat-pseudo-checkbox-full",t.appearance==="full")("_mat-animation-noopable",t._animationsDisabled);},inputs:{state:"state",disabled:"disabled",appearance:"appearance"},decls:0,vars:0,template:function(a,t){},styles:[`.mat-pseudo-checkbox {
  border-radius: 2px;
  cursor: pointer;
