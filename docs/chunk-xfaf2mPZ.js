...
`],encapsulation:2})}return i})();var Ie=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=Yi({type:i});static \u0275inj=hr({imports:[gn]})}return i})();var xi=["*"],ki=`.mdc-list {
  margin: 0;
  padding: 8px 0;
...
`,wi=["unscopedContent"],Ci=["text"],Di=[[["","matListItemAvatar",""],["","matListItemIcon",""]],[["","matListItemTitle",""]],[["","matListItemLine",""]],"*",[["","matListItemMeta",""]],[["mat-divider"]]],Vi=["[matListItemAvatar],[matListItemIcon]","[matListItemTitle]","[matListItemLine]","*","[matListItemMeta]","mat-divider"];var Mi=new w("ListOption"),Ai=(()=>{class i{_elementRef=g(zn);static \u0275fac=function(n){return new(n||i)};static \u0275dir=Jc({type:i,selectors:[["","matListItemTitle",""]],hostAttrs:[1,"mat-mdc-list-item-title","mdc-list-item__primary-text"]})}return i})(),Ei=(()=>{class i{_elementRef=g(zn);static \u0275fac=function(n){return new(n||i)};static \u0275dir=Jc({type:i,selectors:[["","matListItemLine",""]],hostAttrs:[1,"mat-mdc-list-item-line","mdc-list-item__secondary-text"]})}return i})(),Fi=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275dir=Jc({type:i,selectors:[["","matListItemMeta",""]],hostAttrs:[1,"mat-mdc-list-item-meta","mdc-list-item__end"]})}return i})(),Se=(()=>{class i{_listOption=g(Mi,{optional:true});_isAlignedAtStart(){return !this._listOption||this._listOption?._getTogglePosition()==="after"}static \u0275fac=function(n){return new(n||i)};static \u0275dir=Jc({type:i,hostVars:4,hostBindings:function(n,r){n&2&&_h("mdc-list-item__start",r._isAlignedAtStart())("mdc-list-item__end",!r._isAlignedAtStart());}})}return i})(),Ii=(()=>{class i extends Se{static \u0275fac=(()=>{let t;return function(r){return (t||(t=bf(i)))(r||i)}})();static \u0275dir=Jc({type:i,selectors:[["","matListItemAvatar",""]],hostAttrs:[1,"mat-mdc-list-item-avatar"],features:[sh]})}return i})(),Si=(()=>{class i extends Se{static \u0275fac=(()=>{let t;return function(r){return (t||(t=bf(i)))(r||i)}})();static \u0275dir=Jc({type:i,selectors:[["","matListItemIcon",""]],hostAttrs:[1,"mat-mdc-list-item-icon"],features:[sh]})}return i})(),Oi=new w("MAT_LIST_CONFIG"),St=(()=>{class i{_isNonInteractive=true;get disableRipple(){return this._disableRipple}set disableRipple(t){this._disableRipple=pu(t);}_disableRipple=false;get disabled(){return this._disabled()}set disabled(t){this._disabled.set(pu(t));}_disabled=Le$1(false);_defaultOptions=g(Oi,{optional:true});static \u0275fac=function(n){return new(n||i)};static \u0275dir=Jc({type:i,hostVars:1,hostBindings:function(n,r){n&2&&dh("aria-disabled",r.disabled);},inputs:{disableRipple:"disableRipple",disabled:"disabled"}})}return i})(),Ni=(()=>{class i{_elementRef=g(zn);_ngZone=g(G);_listBase=g(St,{optional:true});_platform=g(W$2);_hostElement;_isButtonElement;_noopAnimations=be$1();_avatars;_icons;set lines(t){this._explicitLines=gr(t,null),this._updateItemLines(false);}_explicitLines=null;get disableRipple(){return this.disabled||this._disableRipple||this._noopAnimations||!!this._listBase?.disableRipple}set disableRipple(t){this._disableRipple=pu(t);}_disableRipple=false;get disabled(){return this._disabled()||!!this._listBase?.disabled}set disabled(t){this._disabled.set(pu(t));}_disabled=Le$1(false);_subscriptions=new W$1;_rippleRenderer=null;_hasUnscopedTextContent=false;rippleConfig;get rippleDisabled(){return this.disableRipple||!!this.rippleConfig.disabled}constructor(){g(Ae$2).load(us);let t=g(Ar,{optional:true});this.rippleConfig=t||{},this._hostElement=this._elementRef.nativeElement,this._isButtonElement=this._hostElement.nodeName.toLowerCase()==="button",this._listBase&&!this._listBase._isNonInteractive&&this._initInteractiveListItem(),this._isButtonElement&&!this._hostElement.hasAttribute("type")&&this._hostElement.setAttribute("type","button");}ngAfterViewInit(){this._monitorProjectedLinesAndTitle(),this._updateItemLines(true);}ngOnDestroy(){this._subscriptions.unsubscribe(),this._rippleRenderer!==null&&this._rippleRenderer._removeTriggerEvents();}_hasIconOrAvatar(){return !!(this._avatars.length||this._icons.length)}_initInteractiveListItem(){this._hostElement.classList.add("mat-mdc-list-item-interactive"),this._rippleRenderer=new At$1(this,this._ngZone,this._hostElement,this._platform,g(re$1)),this._rippleRenderer.setupTriggerEvents(this._hostElement);}_monitorProjectedLinesAndTitle(){this._ngZone.runOutsideAngular(()=>{this._subscriptions.add(sm(this._lines.changes,this._titles.changes).subscribe(()=>this._updateItemLines(false)));});}_updateItemLines(t){if(!this._lines||!this._titles||!this._unscopedContent)return;t&&this._checkDomForUnscopedTextContent();let n=this._explicitLines??this._inferLinesFromContent(),r=this._unscopedContent.nativeElement;if(this._hostElement.classList.toggle("mat-mdc-list-item-single-line",n<=1),this._hostElement.classList.toggle("mdc-list-item--with-one-line",n<=1),this._hostElement.classList.toggle("mdc-list-item--with-two-lines",n===2),this._hostElement.classList.toggle("mdc-list-item--with-three-lines",n===3),this._hasUnscopedTextContent){let o=this._titles.length===0&&n===1;r.classList.toggle("mdc-list-item__primary-text",o),r.classList.toggle("mdc-list-item__secondary-text",!o);}else r.classList.remove("mdc-list-item__primary-text"),r.classList.remove("mdc-list-item__secondary-text");}_inferLinesFromContent(){let t=this._titles.length+this._lines.length;return this._hasUnscopedTextContent&&(t+=1),t}_checkDomForUnscopedTextContent(){this._hasUnscopedTextContent=Array.from(this._unscopedContent.nativeElement.childNodes).filter(t=>t.nodeType!==t.COMMENT_NODE).some(t=>!!(t.textContent&&t.textContent.trim()));}static \u0275fac=function(n){return new(n||i)};static \u0275dir=Jc({type:i,contentQueries:function(n,r,o){if(n&1&&Eh(o,Ii,4)(o,Si,4),n&2){let s;wI(s=CI())&&(r._avatars=s),wI(s=CI())&&(r._icons=s);}},hostVars:4,hostBindings:function(n,r){n&2&&(dh("aria-disabled",r.disabled)("disabled",r._isButtonElement&&r.disabled||null),_h("mdc-list-item--disabled",r.disabled));},inputs:{lines:"lines",disableRipple:"disableRipple",disabled:"disabled"}})}return i})();var Qn=(()=>{class i extends St{static \u0275fac=(()=>{let t;return function(r){return (t||(t=bf(i)))(r||i)}})();static \u0275cmp=zE({type:i,selectors:[["mat-list"]],hostAttrs:[1,"mat-mdc-list","mat-mdc-list-base","mdc-list"],exportAs:["matList"],features:[tw([{provide:St,useExisting:i}]),sh],ngContentSelectors:xi,decls:1,vars:0,template:function(n,r){n&1&&(DI(),EI(0));},styles:[ki],encapsulation:2})}return i})(),Xn=(()=>{class i extends Ni{_lines;_titles;_meta;_unscopedContent;_itemText;get activated(){return this._activated}set activated(t){this._activated=pu(t);}_activated=false;_getAriaCurrent(){return this._hostElement.nodeName==="A"&&this._activated?"page":null}_hasBothLeadingAndTrailing(){return this._meta.length!==0&&(this._avatars.length!==0||this._icons.length!==0)}static \u0275fac=(()=>{let t;return function(r){return (t||(t=bf(i)))(r||i)}})();static \u0275cmp=zE({type:i,selectors:[["mat-list-item"],["a","mat-list-item",""],["button","mat-list-item",""]],contentQueries:function(n,r,o){if(n&1&&Eh(o,Ei,5)(o,Ai,5)(o,Fi,5),n&2){let s;wI(s=CI())&&(r._lines=s),wI(s=CI())&&(r._titles=s),wI(s=CI())&&(r._meta=s);}},viewQuery:function(n,r){if(n&1&&Ih(wi,5)(Ci,5),n&2){let o;wI(o=CI())&&(r._unscopedContent=o.first),wI(o=CI())&&(r._itemText=o.first);}},hostAttrs:[1,"mat-mdc-list-item","mdc-list-item"],hostVars:13,hostBindings:function(n,r){n&2&&(dh("aria-current",r._getAriaCurrent()),_h("mdc-list-item--activated",r.activated)("mdc-list-item--with-leading-avatar",r._avatars.length!==0)("mdc-list-item--with-leading-icon",r._icons.length!==0)("mdc-list-item--with-trailing-meta",r._meta.length!==0)("mat-mdc-list-item-both-leading-and-trailing",r._hasBothLeadingAndTrailing())("_mat-animation-noopable",r._noopAnimations));},inputs:{activated:"activated"},exportAs:["matListItem"],features:[sh],ngContentSelectors:Vi,decls:10,vars:0,consts:[["unscopedContent",""],[1,"mdc-list-item__content"],[1,"mat-mdc-list-item-unscoped-content",3,"cdkObserveContent"],[1,"mat-focus-indicator"]],template:function(n,r){n&1&&(DI(Di),EI(0),Pi(1,"span",1),EI(2,1),EI(3,2),Pi(4,"span",2,0),vh("cdkObserveContent",function(){return r._updateItemLines(true)}),EI(6,3),iu()(),EI(7,4),EI(8,5),ph(9,"div",3));},dependencies:[Rd],encapsulation:2})}return i})();var Zn=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=Yi({type:i});static \u0275inj=hr({imports:[Cd,ms,Ie,gn,Fe]})}return i})();export{Fe as F,Ji as J,Qn as Q,Xn as X,Zn as Z,bt as b,hn as h,j,me as m,nn as n,on as o,pi as p,rn as r,sn as s,tn as t,vi as v,yi as y};